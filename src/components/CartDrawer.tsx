              ...
              {items.length > 0 && (
                <div className="border-t border-white/10 px-6 py-4 space-y-3">
                  ...
                  <button
                    ...
                    className="w-full h-14 text-xs tracking-[0.2em] uppercase font-semibold bg-white text-black hover:bg-transparent hover:text-white border border-white transition-colors"
                  >
                    Pagar con Wompi
                  </button>
                </div>

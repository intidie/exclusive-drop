      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="w-full sm:max-w-lg bg-black text-white border border-white/25"
          >
            ...
            <div className="px-6 py-6 space-y-4">
              <h3 className="text-2xl font-display tracking-wide">Tu pago se acuerda en el chat.</h3>
              ...
              <p className="text-sm font-semibold border border-white/25 px-4 py-3">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex-1 inline-flex items-center justify-center h-13 py-4 px-6 bg-black text-white text-xs tracking-[0.2em] uppercase font-semibold border border-white/25 hover:bg-white hover:text-black transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex-1 inline-flex items-center justify-center py-4 px-6 text-xs tracking-[0.2em] uppercase font-semibold border border-white/25 hover:bg-white hover:text-black transition-colors"
                >
                  Instagram
                </a>
              </div>
